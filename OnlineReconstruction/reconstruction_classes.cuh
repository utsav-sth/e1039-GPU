...
class __align__(8) gFullTrackBuilder{
public:
...
class __align__(8) gStraightTrackBuilder{
public:
	gTrack2D trackXZ;
	gTrack2D trackYZ;
	gTrack2D besttrackYZ;
        ...
        //pairs in station 2
        thrust::pair<int, int> hitpairs_x2[150];
        thrust::pair<int, int> hitpairs_u2[150];
        thrust::pair<int, int> hitpairs_v2[150];
        //pairs in station 3
        thrust::pair<int, int> hitpairs_x3[300];
        thrust::pair<int, int> hitpairs_u3[300];
        thrust::pair<int, int> hitpairs_v3[300];
};

class __align__(8) gStraightFitArrays {
public:
      int npoints;
...
class __align__(8) gKalmanFitArrays{
public:
...
class __align__(8) gOutputEvent {
public:
	int EventID;
	int nAH;
	bool HasTooManyHits;//bool to flag an event with too many hits
